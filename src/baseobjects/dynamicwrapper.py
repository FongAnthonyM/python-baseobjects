...
# -*- coding: utf-8 -*-
""" dynamicwrapper.py
A class whose instances call the methods and attributes of other objects and acts as if it is inheriting them.
"""
...
class DynamicWrapper(abc.ABC):
    ...
    def __copy__(self):
        ...
        Returns:
            :obj:`DynamicWrapper`: A shallow copy of this object.
        """
        new = type(self)()
    ...
    def __deepcopy__(self, memo={}):
        ...
        Returns:
            :obj:`DynamicWrapper`: A deep copy of this object.
        """
        new = type(self)()
