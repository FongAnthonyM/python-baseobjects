...
def practical_example():
    ...
    try:
        ...
        if not all(is_working_hours(t) for t in [meeting_time_ny, meeting_time_london, meeting_time_tokyo, meeting_time_sydney]):
            ...
            for hour in range(24):
                ...
                if all(is_working_hours(t) for t in [proposed_time_ny, proposed_time_london, proposed_time_tokyo, proposed_time_sydney]):
