...
from baseobjects.functions import MethodRegistry, FunctionRegistry
...
def method_registry_vs_function_registry():
    ...
    print("\nRegistry instances:")
    print(f"instance1.method_registry is instance2.method_registry: {instance1.method_registry is instance2.method_registry}")
    print(f"instance1.function_registry is instance2.function_registry: {instance1.function_registry is instance2.function_registry}")
